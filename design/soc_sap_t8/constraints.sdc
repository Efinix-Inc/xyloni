...
set_output_delay -clock io_systemClk -min -1.784 [get_ports {system_spi_1_io_ss}]
set_output_delay -clock io_systemClk -max -3.903 [get_ports {system_spi_1_io_sclk_write}]
set_output_delay -clock io_systemClk -min -1.784 [get_ports {system_spi_1_io_sclk_write}]
...
set_output_delay -clock io_systemClk -min -1.784 [get_ports {system_spi_1_io_data_0_write}]
set_output_delay -clock io_systemClk -max -3.913 [get_ports {system_spi_1_io_data_0_writeEnable}]
set_output_delay -clock io_systemClk -min -1.786 [get_ports {system_spi_1_io_data_0_writeEnable}]
...
set_output_delay -clock io_systemClk -min -1.784 [get_ports {system_spi_1_io_data_1_write}]
set_output_delay -clock io_systemClk -max -3.913 [get_ports {system_spi_1_io_data_1_writeEnable}]
set_output_delay -clock io_systemClk -min -1.786 [get_ports {system_spi_1_io_data_1_writeEnable}]
...
set_output_delay -clock io_systemClk -min -1.786 [get_ports {system_spi_0_io_data_0_writeEnable}]
...
create_clock -period 166.67 [get_ports {jtag_inst1_DRCK}]
set_output_delay -clock jtag_inst1_TCK -max 0.155 [get_ports {jtag_inst1_TDO}]
set_output_delay -clock jtag_inst1_TCK -min 0.053 [get_ports {jtag_inst1_TDO}]
set_input_delay -clock_fall -clock jtag_inst1_TCK -max 0.374 [get_ports {jtag_inst1_CAPTURE}]
set_input_delay -clock_fall -clock jtag_inst1_TCK -min 0.134 [get_ports {jtag_inst1_CAPTURE}]
